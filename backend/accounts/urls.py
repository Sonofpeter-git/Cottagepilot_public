...
urlpatterns = [
    path('login/', CustomObtainAuthToken.as_view(), name='login'),#CustomObtainAuthToken.as_view(), name='login'),
    path('signup/', signup, name='login'),#CustomObtainAuthToken.as_view(), name='login'),
